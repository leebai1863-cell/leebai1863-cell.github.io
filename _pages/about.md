...
announcements:
  enabled: true # Show news items
  scrollable: true # Add vertical scroll bar
  limit: 5 # Show max 5 news items
latest_posts:
  enabled: false # Hide latest posts
  scrollable: true # Add vertical scroll bar
